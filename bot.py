...
Introduce_Ans = ["My name is Lakshay's Bot.", "My name is Lakshay's Bot you can called me lb.", "Im Lakshay's Bot :) ",
                 "My name is Lakshay's Bot. and my nickname is lb and i am happy to solve your queries :) "]
GREETING_INPUTS = ("hello", "hi", "hiii", "hii", "hiiii", "hiiii", "greetings", "sup", "what's up", "hey","ok")
...
def chat(user_response):
    ...
    if (user_response != 'bye'):
        ...
        elif (user_response == 'who are you' or user_response == 'who made you'):
            flag = False
            # print("ROBO: You are welcome..")
            return "Lakshay Singhwal made me"
        elif (user_response == 'how are you' or user_response == 'how are you doing'):
            flag = False
            # print("ROBO: You are welcome..")
            return "I am pretty Cool...."
        elif (user_response == '' ):
            flag = False
            # print("ROBO: You are welcome..")
            return "Please enter your Query Gentleman!!"
